...
class Home extends Component {
  ...
  render() {
    if (this.state.packagePage === true)
      return <Redirect to={"/viewPackages/" + this.state.continent} Component={PackageContinent}/>;
    return (
      <div>
        <header className="masthead book-page" id="page-top">
          <div className="container d-flex h-100 align-items-center">
            <div className="mx-auto text-center">
              <h1 className="mx-auto my-0 text-uppercase">Destination</h1>
            ...
            <div className="row">
              <div className="col-lg-8 mx-auto">
                ...
                <p className="about-paragraph text-center">
                  ...
                  formalities sorted beforehand. At <a href="/">Destination</a>,
        ...
        {/* Uncomment the below section after implementing ViewAllPackages */}
        <section>
              ...
              <div className="col-md-4 mb-3 mb-md-0">
                <div className="card py-4 h-100">
                  <div className="card-body text-center">
                    ...
                    <hr className="my-4" />
                    <div className="small text-black-50">Destination</div>
                  </div>
                </div>
              </div>
                ...
                <div className="card py-4 h-100">
                  <div className="card-body text-center">
                    ...
                    <div className="small text-black-50">
                      <Link to="/home">Destination123@yahoo.com</Link>
                    </div>
                  </div>
                </div>
              </div>
